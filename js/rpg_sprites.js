...
Sprite_Enemy.prototype.initMembers = function() {
    ...
    this.offsetAnimation = Math.randomInt(100)
};
...
Sprite_Enemy.prototype.update = function() {
    ...
    this._offsetY = 20 * Math.sin(sec + this.offsetAnimation)
    Sprite_Battler.prototype.update.call(this);
    if (this._enemy) {
        this.updateEffect();
...
Spriteset_Battle.prototype.createBattleField = function() {
    ...
    this._battleField.scale.x /= 1.5
    this._battleField.scale.y /= 1.5
    this._battleField.x += width / 4
    this._battleField.y += 100
...
Spriteset_Battle.prototype.createBattleback = function() {
    ...
    // this._back1Sprite.setColor(0, 0, 0);

    this._back1Sprite.bitmap = this.battleBackgroundBlack();
    this._back2Sprite.bitmap = this.battleback2Bitmap();
    this._back1Sprite.move(x + 140, y, width, height - 140);
...
Spriteset_Battle.prototype.battleBackgroundBlack = function() {
    var bitmap = ImageManager.loadEmptyBitmap()
